...
<div id="izbdy">
<span id="tgtext-1">
<?php if( get_theme_mod( "tgtext-1") != "" ) {echo get_theme_mod( "tgtext-1");} else {echo "In";} ?>
</span>
</div>
<div id="ib2lh">
<span id="tgtext-2">
<?php if( get_theme_mod( "tgtext-2") != "" ) {echo get_theme_mod( "tgtext-2");} else {echo "Insert your text here";} ?>
</span>
</div>
</div>
<div id="i5r9f">
<div id="ihzl6">
<span id="tgtext-3">
<?php if( get_theme_mod( "tgtext-3") != "" ) {echo get_theme_mod( "tgtext-3");} else {echo "Insert your text here";} ?>
</span>
</div>
<div id="i9jxb">
<span id="tgtext-4">
